...
$usuario_nombre=$_SESSION["usuario_nombre"];
	...
	$tel=$_REQUEST["tel"];
	mysql_query("insert into profesores(nombre,materia,mail,domicilio,tel) value ('$nombre','$materia','$mail','$domicilio','$tel')");
	?>
<!DOCTYPE HTML>
<html lang "es">
<head>
...
<center>
	...
	<tr><td><table width="500px" height="500px" align="center" border="1">
		...
		<tr><td align="center" colspan="2"><a href="nueva_cuenta_profesores.php"><button class="button">ingresar otra cuenta</button></a></td></tr>
